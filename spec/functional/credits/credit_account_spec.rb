...
feature "Credit Account" do
	...
	Steps "Error crediting account - Error in card data" do
		...
		And "I fill in card number" do
			page.fill_in "number", :with => '123456789012345'
		end
		And "I fill in CVV" do
			page.fill_in "cvv", :with => '123'
		end
		...
		Then "I should see error on card number field" do
