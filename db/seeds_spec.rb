# This file should contain all the record creation needed to seed the test database with its default values.
# The data can then be loaded with the rake db:seed_spec.
#
